...
const Skill = ({ text, x, y }: { text: string; x: number; y: number }) => {
  return (
    <motion.div
      className="absolute flex justify-center items-center rounded-full font-semibold bg-black text-white p-4 shadow-dark cursor-pointer"
...
export default function Skills() {
  return (
    <div id="skills">
      <div className="my-6 text-2xl font-extrabold">Skills</div>
      <div className="w-full h-vh flex items-center justify-center">
        <div className="hidden md:flex justify-center items-center rounded-full bg-circularLight min-w-[950px] h-screen">
          <motion.div
